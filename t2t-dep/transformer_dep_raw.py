...
class TransformerDepRaw(transformer.Transformer):
    ...
    def model_fn_body(self, features):
        ...
        inputs = tf.concat([features["inputs"], tf.expand_dims(features["dep_pos"], -2)], -1)
    ...
    def model_fn(self, features, skip=False, last_position_only=False):
        ...
        # TODO: HACK to lure modality size downto 508
        self._hparams.hidden_size = self._hparams.hidden_size - 4
